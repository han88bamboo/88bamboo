...
theme.MobileNav = (function() {
  ...
  function cacheSelectors() {
    cache = {
      ...
      $mobileNavContainer: $('.side-mobile-nav-wrapper, .mobile-nav-wrapper'), /*zhe han added .side-mobile-nav-wrapper, */
      $mobileNav: $('#MobileNav'),
...
//========== Below is Added by Zhe Han - help enable sticky bar =====//

  
/*  
deactivated this code- it's unnecessary for sticky bar  
function headerSize() {
...
/*  
//removes mobile chat box if screen loads wider than 700px    - zhe han 
var div1 = document.getElementById('cid0020000314592871754');
...
/* $(document).ready(function(){document.write('Hello World').appendTo("#shopify-section-1612542909fb9fb0d1")});


     
     $(document).ready(function () {
            $("#shopify-section-1612542909fb9fb0d1")
                .clone()
                .appendTo("#tabmenu1");
        });
...
*/
    ...
    var div2 = getElementsByClassName('disqus-footer');
    div2.remove();
